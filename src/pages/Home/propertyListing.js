...
function PropertyListing() {
  return (
    <div className="max-w-[1320px] mx-auto relative mt-[60px]">
      <div>
      ...
      <div className="flex flex-wrap gap-4 sm:gap-10 my-5 mx-10">
        <div className="text-[15px] sm:text-[17px] font-semibold">All</div>
        <div className="text-[15px] sm:text-[17px] font-semibold text-gray-400">
          New listing
        </div>
        <div className="text-[15px] sm:text-[17px] font-semibold text-gray-400">
          For Sale
