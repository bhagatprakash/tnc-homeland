      ...
      <div className="max-w-[800px] mx-auto my-10 p-[10px]">
        <div className="bg-accent/20">
          <div>
            ...
            <h1 className="lg:text-[45px] text-[28px] font-semibold my-5 ">
          ...
          <div className="w-full my-5 flex justify-center">
            <div className="w-[1320px] rounded-lg ">
              {frequentlayAskQuestion.map((item, i) => (
                <div key={i} className="border-b last:border-b-0 shadow  my-7">
                  <div
                  ...
                  >
                    <p className="flex-1 text-left text-[18px] font-normal">
                      {item.title}
                    </p>
